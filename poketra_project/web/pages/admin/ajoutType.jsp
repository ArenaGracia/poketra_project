...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form class="forms-sample" action="<%= request.getContextPath() %>/add_type" method="post">
          <div class="form-group">
            <label for="exampleInputUsername1">Type</label>
            <input type="text" class="form-control" id="exampleInputUsername1" name="type" placeholder="type">
          </div>
          <%if(message != null){ %>
